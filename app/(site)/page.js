    ...
    <div className="bg-slate-50 min-h-screen pb-12">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-600">
              ...
              <Link href="/product" className="hover:text-blue-600">Sản phẩm</Link>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-16 px-4">
        <div className="max-w-7xl mx-auto text-center space-y-4">
          <h1 className="text-4xl font-extrabold sm:text-5xl">Chào mừng đến với TechStore</h1>
          <p className="text-lg text-blue-100 max-w-xl mx-auto">Trải nghiệm mua sắm đồ công nghệ trực tuyến kết nối cơ sở dữ liệu thật SQL Server.</p>
        </div>
      </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        <div className="flex justify-between items-center mb-6">
          ...
          <Link href="/product" className="text-sm font-semibold text-blue-600 hover:underline">Xem tất cả &rarr;</Link>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 text-slate-500 text-lg bg-white rounded-2xl border border-slate-200">
            Chưa có sản phẩm nào trong cơ sở dữ liệu SQL Server. 
            <br />
            <Link href="/admin/product" className="text-blue-600 underline mt-2 inline-block">Vào Admin để thêm mới &rarr;</Link>
          </div>
        ) : (
